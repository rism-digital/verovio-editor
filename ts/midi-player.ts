...
import { onMidiLoaded } from '../javascript/utils/midi.js';
import { midiPlayerServer } from '../javascript/utils/midi.js';
import { MidiPlayerModule } from '../javascript/utils/midi.js';
import { ResponsiveView } from './responsive-view.js';
import { MidiToolbar } from './midi-toolbar.js';

import { initAudio, startAudio, loadScript } from '../javascript/utils/midi.js';
...
export class MidiPlayer {
    ...
    lastUpdate: number;
    midiName: string;
    convertionJob: { sourceMidi: string, targetWav: string, targetPath: string, conversion_start: number };
